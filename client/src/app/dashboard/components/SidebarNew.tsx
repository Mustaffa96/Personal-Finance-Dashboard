...
export default function SidebarNew(props: SidebarProps) {
  // Access props directly without destructuring to avoid any naming issues
  const isMobileOpen = props.isMobileOpen ?? false;
  const onCloseMobile = props.onCloseMobile;
  ...
  // Debug logging
  useEffect(() => {
    console.log('SidebarNew props:', props);
    console.log('SidebarNew isMobileOpen value:', isMobileOpen);
  }, [props, isMobileOpen]);
